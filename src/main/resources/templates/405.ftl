...
<html>
<head>
	<title>VMI`s - Method not allowed!</title>
	<meta charset="utf-8">
        ...
        <div class="container-fluid">
    	 ...
    	 <div class="collapse navbar-collapse martop7" id="myNavbar">
	         <ul class="nav navbar-nav navbar-right">
		        ...
		        <#else>
		         <a href="../corpdetails"><span class="glyphicon glyphicon-home"></span></a>
		        </#if>
		        </li>  
		      </ul>
	      </div>
  			...
  			<div class="col-md-12 col-xs-12 col-lg-12 col-sm-12">
  				<div class="col-md-offset-3 col-sm-offset-0 col-xs-offset-0 col-md-6 col-lg-6 col-xs-12 col-sm-12">
  					<div class="main-content">
  						...
  						<h3 class="text-bold text-center">405. Error!</h3>
  						<h3 class="text-bold text-center"> METHOD NOT ALLOWED !</h3>
  						<h4 class="lightgray text-center text-bold">The request method GET is not allowed.</h4>
  					</div>
  				</div>
  			</div>
  		</div>
